...
const SkillCard = ({ item, index }) => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="absolute inset-0 bg-linear-to-br opacity-0 group-hover:opacity-100 rounded-xl z-0"
          style={{
...
const HobbyBubble = ({ hobby, index, total }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r shadow-lg cursor-pointer whitespace-nowrap"
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(249, 115, 22, 0.8), rgba(234, 88, 12, 0.8))`,
          boxShadow: "0 4px 15px rgba(0, 0, 0, 0.1)",
        }}
        whileHover={{
          scale: 1.1,
          boxShadow: "0 8px 25px rgba(0, 0, 0, 0.15)",
          backgroundImage: `linear-gradient(135deg, rgba(249, 115, 22, 0.9), rgba(234, 88, 12, 0.9))`,
          zIndex: 50,
        }}
      >
...
export const AboutSection = () => {
  ...
  return (
    <div className="py-20 lg:py-28 relative overflow-hidden">
      <div className="absolute -top-40 -left-40 w-80 h-80 bg-orange-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        >
          ...
          >
            <div className="absolute top-0 right-0 w-40 h-40 bg-linear-to-br from-orange-500/20 to-orange-600/20 rounded-full filter blur-3xl"></div>

            <h3 className="text-2xl font-bold mb-6 text-white relative z-10 flex items-center">
              <span className="mr-2 text-transparent bg-clip-text bg-linear-to-r from-orange-400 to-orange-300">
                Tech Toolbox
              </span>
              <div className="h-px grow bg-linear-to-r from-orange-400/50 to-transparent ml-4"></div>
            </h3>
          ...
          >
            <div className="absolute bottom-0 left-0 w-40 h-40 bg-linear-to-tr from-orange-500/20 to-orange-600/20 rounded-full filter blur-3xl"></div>
