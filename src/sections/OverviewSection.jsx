...
const overviewCards = [
  ...
  },
  {
    ...
    description: "Designing and implementing robust server-side applications and APIs that power modern web experiences.",
    icon: Server,
    stats: [
  ...
  },
  {
    ...
    description: "Working with various database technologies to design efficient data models and implement optimized queries.",
    icon: Database,
    stats: [
      { label: "Primary Skills", value: "MongoDB, SQL" },
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {overviewCards.map((card, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <CustomCard className="h-full p-6 md:p-8 bg-white/5 backdrop-blur-sm border border-orange-500/20">
                <div className="inline-flex size-12 items-center justify-center rounded-lg bg-orange-500">
